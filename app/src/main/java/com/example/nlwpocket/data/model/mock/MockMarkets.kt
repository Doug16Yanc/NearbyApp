package com.example.nlwpocket.data.model.mock
...
val mockMarkets = listOf(
    NearbyMarket(
        ...
        coupons = 10,
     /*   rules = listOf(
            NearbyRule(id = "1", description = "Válido até o dia 25/12", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4") ,
            NearbyRule(id = "2", description = "Disponível apenas para consumo local", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4")
