...
fun WelcomeHeader(modifier : Modifier = Modifier) {
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.img_logo_logo_icon),
            contentDescription = "Logo do Nearby app")
        Spacer(modifier = Modifier.height(26.dp))
        Text(text = "Boas vindas ao Nearby", style = Typography.headlineLarge)
        Text(text = "Tenha cupons de vantagens para usar em seus estabelecimentos favoritos", style = Typography.bodyLarge)
    }
}
