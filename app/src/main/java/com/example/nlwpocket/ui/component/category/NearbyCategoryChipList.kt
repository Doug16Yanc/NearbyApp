package com.example.nlwpocket.ui.component.category
...
import com.example.nlwpocket.data.model.domain.Category
...
fun NearbyCategoryFilterChipList(
    ...
    LaunchedEffect(key1 = selectedCategoryId) {
        val selectedCategorOrNull = categories.find { it.id == selectedCategoryId}
        selectedCategorOrNull?.let {onSelectedCategoryChanged(it)}
    }
